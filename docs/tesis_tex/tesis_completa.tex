...
\title{Sistema de monitoreo de variables físicas de colmenas apícolas utilizando IOT y redes neuronales}
\date{\today}
...
% TODO
% Redo introduccion
% reorganizar trabajos relacionados
% Crear cap 4 y pasar IA de cap 3
